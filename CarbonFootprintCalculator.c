...
int main(){
    ...
    float a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, z1, z2, z3, z4, z5;
    ...
    scanf("%f", &ac);
    printf("\nHow many people engaged in this activity with you? Enter 1 if the consumption that you entered was yours only.\n");
    scanf("%f", &a);
